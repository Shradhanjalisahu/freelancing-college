						...
						<form action="{{route('add-state')}}" method="POST" >
							...
							<div class="row">
								<div class="form-group col-md-6 mb-6">
									<label for="listingTitle">State Name</label>
									<input type="text" name="state_name" value="{{old('state_name')}}" class="form-control @error('state_name') is-invalid @enderror" placeholder="Enter college name" >
									@error('state_name')
