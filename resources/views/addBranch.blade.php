			...
			<div class="container">
				...
				<div class="card">
					<div class="card-body px-6 pt-6 pb-1">
						<h3 class="h4 mb-4">Add Branch</h3>
						{{-- @if ($errors->any())
						...
						<form action="{{route('add-branch')}}" method="POST" >
							...
							<div class="row">
								<div class="form-group col-md-6 mb-6">
									<label for="listingTitle">Branch Name</label>
									<input type="text" name="branch_name" value="{{old('branch_name')}}" class="form-control @error('branch_name') is-invalid @enderror" placeholder="Enter college name" >
									@error('branch_name')
